...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
  echo "Source this file so the Q20 run configuration remains in the current shell:" >&2
  echo "  source experiments/1724-kafka-q20-unique/run-env.sh" >&2
  exit 1
fi
